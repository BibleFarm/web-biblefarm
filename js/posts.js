...
console.log(bg_for_this_page);
  ...
  ///////////////////////////////////////////////////
	...
	$('		<script>		/* get them and implement them here: https://developers.google.com/search/docs/data-types/article // test them here: https://search.google.com/structured-data/testing-tool // monitor them here: https://search.google.com/search-console/welcome */ (function() {		  var jsonData = [		    {		      "@context": "http://www.schema.org",		      "@type": "Organization",		      name: "BibleFarm.org",		      url: "https://www.biblefarm.org/",		      sameAs: [		        "https://www.instagram.com/biblefarm/",		        "https://www.facebook.com/BibleFarm.org/",		        "https://www.facebook.com/granjasolidaria/",		        "https://www.facebook.com/groups/BiblieFarm/",		        "https://twitter.com/biblefarm/",		        "https://www.youtube.com/channel/UCqu0sNEEhviHFa8VUd12HnA",		        "https://www.youtube.com/playlist?list=PL-SXzhnj1OgLUY7MqL-RW1FrJSXTpXltA",		        "https://www.pinterest.com/BibleFarm/",		        "https://www.linkedin.com/company/biblefarm-org",		        "https://www.paypal.me/biblefarm"		      ],		      logo:		        "https://www.biblefarm.org/BibleFarm_Facebook_Profile_Picture_tumblr.png",		      image:		        "https://biblefarm.github.io/posts-en-sardonyx/images/Genesis-1-1.png",		      description:		        "Bible doers let\'s https://www.BibleFarm.org/donate & provide better nutrition for these kids. Fulfilling Mat 25:31-40 one visit at a time: The team delivers clothes, shoes & we teach these children to put all their trust in Jesus (John 1:12), share (1John 3:17), apologize (Mat. 5:24) & forgive (Mark 11:26). #biblefarm @biblefarm",		      address: {		        "@type": "PostalAddress",		        streetAddress: "Calle 132 # 777",		        addressLocality: "Posadas",		        addressRegion: "Misiones",		        postalCode: "3300",		        addressCountry: "Argentina"		      }		    },		    {		      "@context": "https://schema.org/",		      "@type": "WebPage",		      name: "Share every verse @ BiblFarm.org",		      speakable: {		        "@type": "SpeakableSpecification",		        xpath: [		          "/html/head/title",		          "/html/head/meta[@name=\'description\']/@content"		        ]		      },		      url: "https://www.biblefarm.org/"		    },		    {		      "@context": "https://schema.org",		      "@type": "SoftwareApplication",		      name: "Share every verse @ BibleFarm.org/app",		      applicationCategory: "Bible Software",		      downloadUrl: "https://www.biblefarm.org/app",		      thumbnailUrl:		        "https://www.biblefarm.org/BibleFarm_Facebook_Profile_Picture_tumblr.png",		      operatingSystem: "ALL",		      aggregateRating: {		        "@type": "AggregateRating",		        ratingValue: "5.0",		        ratingCount: "10"		      },		      offers: { "@type": "Offer", price: "0.00", priceCurrency: "USD" }		    },				    {		      "@context": "https://schema.org",		      "@type": "DefinedTerm",		      name: "Genesis 1:1",		      description: "In the beginning God created the heaven and the earth.",		      image:		        "https://biblefarm.github.io/posts-en-sardonyx/images/Genesis-1-1.png",		      url: "https://sardonyx.biblefarm.org/posts/Genesis-1-1.html"		    }		  ];		  var el = document.createElement("script");		  el.type = "application/ld+json";		  el.innerHTML = JSON.stringify(jsonData);		  document.head.appendChild(el);		})();						</script>		<link href="../css/_o_v_0_6_14_perfect-scrollbar.min.css" rel="stylesheet" type="text/css">').prependTo("head");
